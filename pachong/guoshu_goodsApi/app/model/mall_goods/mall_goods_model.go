...
// arModel is a active record design model for table mall_goods operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of mall_goods.
	Table = "mall_goods"
	// Model is the model object of mall_goods.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table mall_goods.
	Columns = struct {
		Id             string //                                             
        ShopId         string // 店铺id                                      
        Type           string // 商品类型:0=国内商品;1=海外商品              
        TypeTags       string // 商品类型标签:0=无;1=保税;2=直邮;3=一般贸易  
        BuyType        string // 购买类型:0=全部;1=微信;2=点卡               
        BrandId        string // 品牌ID                                      
        CateId         string // 商品分类id                                  
        UnitId         string // 商品单位ID                                  
        SpecId         string // 规格ID                                      
        TagsId         string // 商品标签ID                                  
        Tags           string // 商品展示小标签,输入请使用英文逗号隔开       
        GoodsTitle     string // 商品名                                      
        GoodsStock     string // 商品总库存                                  
        GoodsMinPrice  string // 最低售价                                    
        GoodsPrice     string // 展示价                                      
        GoodsSale      string // 销售数量                                    
        GoodsLook      string // 浏览量                                      
        GoodsContent   string // 商品内容                                    
        GoodsLogo      string // 商品LOGO                                    
        GoodsImage     string // 商品图片地址                                
        GoodsVideo     string // 商品视频URL                                 
        GoodsDesc      string // 商品描述                                    
        IsAudit        string // 是否审核:0=待审核;1=已审核;2=不通过         
        AuditText      string // 审核内容                                    
        AuditAdmin     string // 审核人                                      
        AuditTime      string // 审核时间                                    
        IsShare        string // 是否共享:0=不共享;1=共享                    
        ShareTj        string // 是否共享推荐                                
        TcShare        string // 同城共享0不限1是                            
        IsSpecial      string // 是否特价:0=非特价;1=特价                    
        Integral       string // 特价消耗积分                                
        OffsetPrice    string // 积分抵扣的金额                              
        Status         string // 商品状态:0=销售中;1=已下架                  
        IsTj           string // 是否推荐:0=推荐;1=不推荐                    
        IsDeleted      string // 删除状态:0=未删除;1=删除                    
        ITime          string // 创建时间                                    
        IAdmin         string // 添加用户                                    
        UTime          string // 更新时间                                    
        UAdmin         string // 更新用户
        ...
        GoodsMinPrice: "goods_min_price",  
        GoodsPrice:    "goods_price",      
        GoodsSale:     "goods_sale",       
        GoodsLook:     "goods_look",       
        GoodsContent:  "goods_content",    
        GoodsLogo:     "goods_logo",       
        GoodsImage:    "goods_image",      
        GoodsVideo:    "goods_video",      
